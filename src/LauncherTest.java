...
public class LauncherTest {
	...
	private static final long realteamId = 130; // mettre votre teamId envoyé dans le mail
	private static final String secret ="REG3757UJ4"; // mettre votre secret
	private static final long maxteamId = realteamId + 6; // ne pas toucher
	private static final int socketNumber = 2130; // mettre le port envoyé dans le mail
	...
	public static void main(String[] zero) throws IOException, URISyntaxException, InterruptedException {
		...
		// Pour voir le jeu
		// http://52.29.48.22:8080/?gameId=votre game Id
	}
}
